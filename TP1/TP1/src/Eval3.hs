...
-- Estados
type State = (M.Map Variable Int, [(String, Int)])
...
update v nv (s, xs) = (M.insert v nv s, (v, nv):xs)

-- Evalua un programa en el estado nulo
-- Hacemos un reverse de la traza para que quede en el orden del programa
eval :: Comm -> Either Error State
eval p = case stepCommStar p initState of
              Left e -> Left e
              Right (a, b) -> Right (a, reverse b)
